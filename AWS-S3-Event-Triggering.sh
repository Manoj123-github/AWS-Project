...
bucket_name="manoj-yadav-bucket"
lambda_func_name="manoj-s3-lambda-function"
role_name="s3-lambda-sns"
email_address="manoj.h.yadav1002@gmail.com"
...
aws sns publish \
  ...
  --message "Hello from Manoj Yadav, A new object is created."
